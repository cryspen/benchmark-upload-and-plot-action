...
cp src/default_index.html ./dist/src/

git add action.yml action-types.yml ./dist/src/*.html ./dist/src/*.js ./dist/src/comment/*.js package.json package-lock.json node_modules
set +x
