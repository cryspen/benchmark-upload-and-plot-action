    ...
    describe('with gh-pages branch', function () {
        ...
        afterEach(async function () {
            ...
            for (const p of [
                ...
                path.join('benchmark-data-repository', 'data-dir', 'pr', '10.json'),
        ...
        const normalCasesWithPayloadType: Array<{
            ...
            {
                it: 'raises an alert when exceeding threshold 2.0 for push event with gh repository and base path',
                config: { ...defaultCfg, ghRepository: 'https://github.com/user/other-repo' },
                added: {
                    commit: commit('current commit id'),
                    date: lastUpdate,
            ...
            {
                it: 'raises an alert when exceeding threshold 2.0 for merge group event with gh repository and base path',
                config: { ...defaultCfg, ghRepository: 'https://github.com/user/other-repo' },
                payloadType: PayloadType.MergeGroup,
                added: {
                    commit: commit('current commit id'),
            ...
            {
                it: 'raises an alert when exceeding threshold 2.0 for pull request event with gh-repository and base path',
                config: { ...defaultCfg, ghRepository: 'https://github.com/user/other-repo' },
                payloadType: PayloadType.PullRequest,
                added: {
                    commit: commit('current commit id'),
        ...
        for (const t of normalCasesWithPayloadType) {
            ...
            it(t.it, async function () {
                ...
                // copy data to append to/compare against
